...
y_Tbi_WB_UF <- DGEList(counts=dat1_Tbi[,c(
...
y_Tce_WB_UF <- DGEList(counts=dat1_Tce[,c(
...
y_Tcm_WB_UF <- DGEList(counts=dat1_Tcm[,c(
...
y_Tpa_WB_UF <- DGEList(counts=dat1_Tpa[,c(
...
y_Tps_WB_UF <- DGEList(counts=dat1_Tps[,c(
...
y_Tbi_WB_F_FPKM <- filt_and_norm_maj_FPKM(y_Tbi_WB_UF,FPKM_filt_value,2,dat1_Tbi$tot_exon_len)
y_Tce_WB_F_FPKM <- filt_and_norm_maj_FPKM(y_Tce_WB_UF,FPKM_filt_value,2,dat1_Tce$tot_exon_len)
y_Tcm_WB_F_FPKM <- filt_and_norm_maj_FPKM(y_Tcm_WB_UF,FPKM_filt_value,2,dat1_Tcm$tot_exon_len)
y_Tpa_WB_F_FPKM <- filt_and_norm_maj_FPKM(y_Tpa_WB_UF,FPKM_filt_value,2,dat1_Tpa$tot_exon_len)
y_Tps_WB_F_FPKM <- filt_and_norm_maj_FPKM(y_Tps_WB_UF,FPKM_filt_value,2,dat1_Tps$tot_exon_len)
...
y_Tbi_WB_F_TPM <- filt_and_norm_maj_TPM(y_Tbi_WB_UF,TPM_filt_value,2,dat1_Tbi$tot_exon_len)
y_Tce_WB_F_TPM <- filt_and_norm_maj_TPM(y_Tce_WB_UF,TPM_filt_value,2,dat1_Tce$tot_exon_len)
y_Tcm_WB_F_TPM <- filt_and_norm_maj_TPM(y_Tcm_WB_UF,TPM_filt_value,2,dat1_Tcm$tot_exon_len)
y_Tpa_WB_F_TPM <- filt_and_norm_maj_TPM(y_Tpa_WB_UF,TPM_filt_value,2,dat1_Tpa$tot_exon_len)
y_Tps_WB_F_TPM <- filt_and_norm_maj_TPM(y_Tps_WB_UF,TPM_filt_value,2,dat1_Tps$tot_exon_len)
...
Tbi_WB_F_FPKM <- get_FPKM(y_Tbi_WB_F_FPKM, dat1_Tbi, "Tbi_SF_WB", "Tbi_SM_WB")
Tce_WB_F_FPKM <- get_FPKM(y_Tce_WB_F_FPKM, dat1_Tce, "Tce_SF_WB", "Tce_SM_WB")
Tcm_WB_F_FPKM <- get_FPKM(y_Tcm_WB_F_FPKM, dat1_Tcm, "Tcm_SF_WB", "Tcm_SM_WB")
Tpa_WB_F_FPKM <- get_FPKM(y_Tpa_WB_F_FPKM, dat1_Tpa, "Tpa_SF_WB", "Tpa_SM_WB")
Tps_WB_F_FPKM <- get_FPKM(y_Tps_WB_F_FPKM, dat1_Tps, "Tps_SF_WB", "Tps_SM_WB")
...
Tbi_WB_F_TPM <- get_TPM(y_Tbi_WB_F_TPM, dat1_Tbi, "Tbi_SF_WB", "Tbi_SM_WB")
Tce_WB_F_TPM <- get_TPM(y_Tce_WB_F_TPM, dat1_Tce, "Tce_SF_WB", "Tce_SM_WB")
Tcm_WB_F_TPM <- get_TPM(y_Tcm_WB_F_TPM, dat1_Tcm, "Tcm_SF_WB", "Tcm_SM_WB")
Tpa_WB_F_TPM <- get_TPM(y_Tpa_WB_F_TPM, dat1_Tpa, "Tpa_SF_WB", "Tpa_SM_WB")
Tps_WB_F_TPM <- get_TPM(y_Tps_WB_F_TPM, dat1_Tps, "Tps_SF_WB", "Tps_SM_WB")
...
All_WB_F_FPKM_long <- make_long_table_avEXP("Tbi_WB_F_FPKM", "Tce_WB_F_FPKM", "Tcm_WB_F_FPKM", "Tpa_WB_F_FPKM", "Tps_WB_F_FPKM",  "WB", "FPKM")
...
All_WB_F_TPM_long <- make_long_table_avEXP("Tbi_WB_F_TPM", "Tce_WB_F_TPM", "Tcm_WB_F_TPM", "Tpa_WB_F_TPM", "Tps_WB_F_TPM",  "WB", "TPM")
...
WB_avFPKM <- plot_avFPKM(All_WB_F_FPKM_long, 80,  "WB")
...
WB_avTPM <- plot_avTPM(All_WB_F_TPM_long, 80,  "WB")
...
pdf("WBRTHDLG_avFPKM_soft.pdf", width = 9, height = 12)
plot_grid(
WB_avFPKM$P1_soft, 
RT_avFPKM$P1_soft, 
HD_avFPKM$P1_soft, 
LG_avFPKM$P1_soft, ncol = 1)
dev.off()
getwd() ## where has my plot gone....

pdf("WBRTHDLG_avTPM_soft.pdf", width = 9, height = 12)
plot_grid(
WB_avTPM$P1_soft, 
RT_avTPM$P1_soft, 
HD_avTPM$P1_soft, 
LG_avTPM$P1_soft, ncol = 1)
dev.off()
getwd() ## where has my plot gone....


pdf("WBRTHDLG_avFPKM_hard.pdf", width = 9, height = 12)
plot_grid(
WB_avFPKM$P1_hard, 
RT_avFPKM$P1_hard, 
HD_avFPKM$P1_hard, 
LG_avFPKM$P1_hard, ncol = 1)
dev.off()
getwd() ## where has my plot gone....

pdf("WBRTHDLG_avTPM_hard.pdf", width = 9, height = 12)
plot_grid(
WB_avTPM$P1_hard, 
RT_avTPM$P1_hard, 
HD_avTPM$P1_hard, 
LG_avTPM$P1_hard, ncol = 1)
dev.off()
getwd() ## where has my plot gone....
...
All_WB_F_FPKM_log2MF_long <- make_long_table_log2MF("Tbi_WB_F_FPKM", "Tce_WB_F_FPKM", "Tcm_WB_F_FPKM", "Tpa_WB_F_FPKM", "Tps_WB_F_FPKM",  "WB", "FPKM")
...
All_WB_F_TPM_log2MF_long <- make_long_table_log2MF("Tbi_WB_F_TPM", "Tce_WB_F_TPM", "Tcm_WB_F_TPM", "Tpa_WB_F_TPM", "Tps_WB_F_TPM",  "WB", "TPM")
...
head(All_WB_F_FPKM_log2MF_long)
...
WB_FPKM_log2MF <- plot_FPKM_log2MF(All_WB_F_FPKM_log2MF_long, "WB")
...
WB_TPM_log2MF <- plot_TPM_log2MF(All_WB_F_TPM_log2MF_long, "WB")
...
pdf("WBRTHDLG_FPKM_log2MF_soft.pdf", width = 6, height = 12)
plot_grid(
WB_FPKM_log2MF$P1_soft, 
RT_FPKM_log2MF$P1_soft, 
HD_FPKM_log2MF$P1_soft, 
LG_FPKM_log2MF$P1_soft,ncol = 1)
dev.off()
getwd() ## where has my plot gone....

pdf("WBRTHDLG_FPKM_log2MF_hard.pdf", width = 6, height = 12)
plot_grid(
WB_FPKM_log2MF$P1_hard, 
RT_FPKM_log2MF$P1_hard, 
HD_FPKM_log2MF$P1_hard, 
LG_FPKM_log2MF$P1_hard,ncol = 1)
dev.off()
getwd() ## where has my plot gone....

### output

pdf("WBRTHDLG_TPM_log2MF_soft.pdf", width = 6, height = 12)
plot_grid(
WB_TPM_log2MF$P1_soft, 
RT_TPM_log2MF$P1_soft, 
HD_TPM_log2MF$P1_soft, 
LG_TPM_log2MF$P1_soft,ncol = 1)
dev.off()
getwd() ## where has my plot gone....

pdf("WBRTHDLG_TPM_log2MF_hard.pdf", width = 6, height = 12)
plot_grid(
WB_TPM_log2MF$P1_hard, 
RT_TPM_log2MF$P1_hard, 
HD_TPM_log2MF$P1_hard, 
LG_TPM_log2MF$P1_hard,ncol = 1)
dev.off()
getwd() ## where has my plot gone....


pdf("WBRTHDLG_FPKM_log2MF_LG.pdf", width = 9, height = 18)
plot_grid(
plot_FPKM_log2MF_LG(All_WB_F_FPKM_log2MF_long, "WB"),
plot_FPKM_log2MF_LG(All_RT_F_FPKM_log2MF_long, "RT"), 
plot_FPKM_log2MF_LG(All_HD_F_FPKM_log2MF_long, "HD"),
plot_FPKM_log2MF_LG(All_LG_F_FPKM_log2MF_long, "LG"),ncol = 1)
dev.off()
getwd() ## where has my plot gone....

pdf("WBRTHDLG_TPM_log2MF_LG.pdf", width = 9, height = 18)
plot_grid(
plot_TPM_log2MF_LG(All_WB_F_TPM_log2MF_long, "WB"),
plot_TPM_log2MF_LG(All_RT_F_TPM_log2MF_long, "RT"), 
plot_TPM_log2MF_LG(All_HD_F_TPM_log2MF_long, "HD"),
plot_TPM_log2MF_LG(All_LG_F_TPM_log2MF_long, "LG"),ncol = 1)
dev.off()
getwd() ## where has my plot gone....
...
FPKM_log2MF_hist_Tbi_WB <- FPKM_MF_hists(All_WB_F_FPKM_log2MF_long,"Tbi","WB")
...
FPKM_log2MF_hist_Tce_WB <- FPKM_MF_hists(All_WB_F_FPKM_log2MF_long,"Tce","WB")
...
FPKM_log2MF_hist_Tcm_WB <- FPKM_MF_hists(All_WB_F_FPKM_log2MF_long,"Tcm","WB")
...
FPKM_log2MF_hist_Tpa_WB <- FPKM_MF_hists(All_WB_F_FPKM_log2MF_long,"Tpa","WB")
...
FPKM_log2MF_hist_Tps_WB <- FPKM_MF_hists(All_WB_F_FPKM_log2MF_long,"Tps","WB")
...
plot_grid(
FPKM_log2MF_hist_Tbi_WB$P3_soft, FPKM_log2MF_hist_Tce_WB$P3_soft, FPKM_log2MF_hist_Tcm_WB$P3_soft, FPKM_log2MF_hist_Tpa_WB$P3_soft, FPKM_log2MF_hist_Tps_WB$P3_soft,
...
pdf("FPKM_log2MF_hist_soft_all.pdf", width = 14, height = 12)
FPKM_log2MF_hist_soft_all
dev.off()
getwd() ## where has my plot gone....
...
plot_grid(
FPKM_log2MF_hist_Tbi_WB$P3_hard, FPKM_log2MF_hist_Tce_WB$P3_hard, FPKM_log2MF_hist_Tcm_WB$P3_hard, FPKM_log2MF_hist_Tpa_WB$P3_hard, FPKM_log2MF_hist_Tps_WB$P3_hard,
...
pdf("FPKM_log2MF_hist_hard_all.pdf", width = 14, height = 12)
FPKM_log2MF_hist_hard_all
dev.off()
getwd() ## where has my plot gone....
...
TPM_log2MF_hist_Tbi_WB <- TPM_MF_hists(All_WB_F_TPM_log2MF_long,"Tbi","WB")
...
TPM_log2MF_hist_Tce_WB <- TPM_MF_hists(All_WB_F_TPM_log2MF_long,"Tce","WB")
...
TPM_log2MF_hist_Tcm_WB <- TPM_MF_hists(All_WB_F_TPM_log2MF_long,"Tcm","WB")
...
TPM_log2MF_hist_Tpa_WB <- TPM_MF_hists(All_WB_F_TPM_log2MF_long,"Tpa","WB")
...
TPM_log2MF_hist_Tps_WB <- TPM_MF_hists(All_WB_F_TPM_log2MF_long,"Tps","WB")
...
plot_grid(
TPM_log2MF_hist_Tbi_WB$P3_soft, TPM_log2MF_hist_Tce_WB$P3_soft, TPM_log2MF_hist_Tcm_WB$P3_soft, TPM_log2MF_hist_Tpa_WB$P3_soft, TPM_log2MF_hist_Tps_WB$P3_soft,
...
pdf("TPM_log2MF_hist_soft_all.pdf", width = 14, height = 12)
TPM_log2MF_hist_soft_all
dev.off()
getwd() ## where has my plot gone....
...
plot_grid(
TPM_log2MF_hist_Tbi_WB$P3_hard, TPM_log2MF_hist_Tce_WB$P3_hard, TPM_log2MF_hist_Tcm_WB$P3_hard, TPM_log2MF_hist_Tpa_WB$P3_hard, TPM_log2MF_hist_Tps_WB$P3_hard,
...
pdf("TPM_log2MF_hist_hard_all.pdf", width = 14, height = 12)
TPM_log2MF_hist_hard_all
dev.off()
getwd() ## where has my plot gone....
...
TTT_WB_Tbi_sex_bias_FPKM <- call_SB(y_Tbi_WB_F_FPKM, 0.05)
TTT_WB_Tce_sex_bias_FPKM <- call_SB(y_Tce_WB_F_FPKM, 0.05)
TTT_WB_Tcm_sex_bias_FPKM <- call_SB(y_Tcm_WB_F_FPKM, 0.05)
TTT_WB_Tpa_sex_bias_FPKM <- call_SB(y_Tpa_WB_F_FPKM, 0.05)
TTT_WB_Tps_sex_bias_FPKM <- call_SB(y_Tps_WB_F_FPKM, 0.05)
...
rep(c("Tbi", "Tce", "Tcm", "Tpa", "Tps"), 4),
c(rep("WB", 5), rep("RT", 5), rep("HD", 5), rep("LG", 5)),
c(
length(TTT_WB_Tbi_sex_bias_FPKM$S_gene_list),
length(TTT_WB_Tce_sex_bias_FPKM$S_gene_list),
length(TTT_WB_Tcm_sex_bias_FPKM$S_gene_list),
length(TTT_WB_Tpa_sex_bias_FPKM$S_gene_list),
length(TTT_WB_Tps_sex_bias_FPKM$S_gene_list),
...
TTT_WB_Tbi_sex_bias_TPM <- call_SB(y_Tbi_WB_F_TPM, 0.05)
TTT_WB_Tce_sex_bias_TPM <- call_SB(y_Tce_WB_F_TPM, 0.05)
TTT_WB_Tcm_sex_bias_TPM <- call_SB(y_Tcm_WB_F_TPM, 0.05)
TTT_WB_Tpa_sex_bias_TPM <- call_SB(y_Tpa_WB_F_TPM, 0.05)
TTT_WB_Tps_sex_bias_TPM <- call_SB(y_Tps_WB_F_TPM, 0.05)
...
c(rep("WB", 5), rep("RT", 5), rep("HD", 5), rep("LG", 5)),
c(
length(TTT_WB_Tbi_sex_bias_TPM$S_gene_list),
length(TTT_WB_Tce_sex_bias_TPM$S_gene_list),
length(TTT_WB_Tcm_sex_bias_TPM$S_gene_list),
length(TTT_WB_Tpa_sex_bias_TPM$S_gene_list),
length(TTT_WB_Tps_sex_bias_TPM$S_gene_list),
...
plot_smear <- function(expr_df, expr_df_name, exp_name, DE_genes_tab, FDR_th, tit_txt, exp_type, max_FC){
	...
	DE_genes_df$sig <- ifelse(DE_genes_df$FDR <= FDR_th, "sig", "non-sig")
	...
	## get max FC so I can make symmetrical plots          
	#max_FC <- ceiling(max(abs(DE_genes_df_2$logFC)))
...
plot_smear_XA <- function(expr_df, expr_df_name, exp_name, DE_genes_tab, FDR_th, tit_txt, exp_type, max_FC, chr_type){
...
## so same scale
WB_max_FC <- ceiling(max(abs(c(TTT_WB_Tbi_sex_bias_FPKM$table$logFC, TTT_WB_Tce_sex_bias_FPKM$table$logFC, TTT_WB_Tcm_sex_bias_FPKM$table$logFC,TTT_WB_Tpa_sex_bias_FPKM$table$logFC,TTT_WB_Tps_sex_bias_FPKM$table$logFC))))
SB_WB_FPKM_smear <- plot_grid(
plot_smear(Tbi_WB_F_FPKM, "Tbi_WB_F_FPKM", "Tbi_WB_meanFPKM", TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, "Tbi WB", "FPKM", WB_max_FC),
plot_smear(Tce_WB_F_FPKM, "Tce_WB_F_FPKM", "Tce_WB_meanFPKM", TTT_WB_Tce_sex_bias_FPKM$table, 0.05, "Tce WB", "FPKM", WB_max_FC),
plot_smear(Tcm_WB_F_FPKM, "Tcm_WB_F_FPKM", "Tcm_WB_meanFPKM", TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, "Tcm WB", "FPKM", WB_max_FC),
plot_smear(Tpa_WB_F_FPKM, "Tpa_WB_F_FPKM", "Tpa_WB_meanFPKM", TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, "Tpa WB", "FPKM", WB_max_FC),
plot_smear(Tps_WB_F_FPKM, "Tps_WB_F_FPKM", "Tps_WB_meanFPKM", TTT_WB_Tps_sex_bias_FPKM$table, 0.05, "Tps WB", "FPKM", WB_max_FC), ncol = 2)
...
plot_smear(Tbi_RT_F_FPKM, "Tbi_RT_F_FPKM", "Tbi_RT_meanFPKM", TTT_RT_Tbi_sex_bias_FPKM$table, 0.05, "Tbi RT", "FPKM", RT_max_FC),
plot_smear(Tce_RT_F_FPKM, "Tce_RT_F_FPKM", "Tce_RT_meanFPKM", TTT_RT_Tce_sex_bias_FPKM$table, 0.05, "Tce RT", "FPKM", RT_max_FC),
plot_smear(Tcm_RT_F_FPKM, "Tcm_RT_F_FPKM", "Tcm_RT_meanFPKM", TTT_RT_Tcm_sex_bias_FPKM$table, 0.05, "Tcm RT", "FPKM", RT_max_FC),
plot_smear(Tpa_RT_F_FPKM, "Tpa_RT_F_FPKM", "Tpa_RT_meanFPKM", TTT_RT_Tpa_sex_bias_FPKM$table, 0.05, "Tpa RT", "FPKM", RT_max_FC),
plot_smear(Tps_RT_F_FPKM, "Tps_RT_F_FPKM", "Tps_RT_meanFPKM", TTT_RT_Tps_sex_bias_FPKM$table, 0.05, "Tps RT", "FPKM", RT_max_FC), ncol = 2)
...
plot_smear(Tbi_HD_F_FPKM, "Tbi_HD_F_FPKM", "Tbi_HD_meanFPKM", TTT_HD_Tbi_sex_bias_FPKM$table, 0.05, "Tbi HD", "FPKM", HD_max_FC),
plot_smear(Tce_HD_F_FPKM, "Tce_HD_F_FPKM", "Tce_HD_meanFPKM", TTT_HD_Tce_sex_bias_FPKM$table, 0.05, "Tce HD", "FPKM", HD_max_FC),
plot_smear(Tcm_HD_F_FPKM, "Tcm_HD_F_FPKM", "Tcm_HD_meanFPKM", TTT_HD_Tcm_sex_bias_FPKM$table, 0.05, "Tcm HD", "FPKM", HD_max_FC),
plot_smear(Tpa_HD_F_FPKM, "Tpa_HD_F_FPKM", "Tpa_HD_meanFPKM", TTT_HD_Tpa_sex_bias_FPKM$table, 0.05, "Tpa HD", "FPKM", HD_max_FC),
plot_smear(Tps_HD_F_FPKM, "Tps_HD_F_FPKM", "Tps_HD_meanFPKM", TTT_HD_Tps_sex_bias_FPKM$table, 0.05, "Tps HD", "FPKM", HD_max_FC), ncol = 2)
...
plot_smear(Tbi_LG_F_FPKM, "Tbi_LG_F_FPKM", "Tbi_LG_meanFPKM", TTT_LG_Tbi_sex_bias_FPKM$table, 0.05, "Tbi LG", "FPKM", LG_max_FC),
plot_smear(Tce_LG_F_FPKM, "Tce_LG_F_FPKM", "Tce_LG_meanFPKM", TTT_LG_Tce_sex_bias_FPKM$table, 0.05, "Tce LG", "FPKM", LG_max_FC),
plot_smear(Tcm_LG_F_FPKM, "Tcm_LG_F_FPKM", "Tcm_LG_meanFPKM", TTT_LG_Tcm_sex_bias_FPKM$table, 0.05, "Tcm LG", "FPKM", LG_max_FC),
plot_smear(Tpa_LG_F_FPKM, "Tpa_LG_F_FPKM", "Tpa_LG_meanFPKM", TTT_LG_Tpa_sex_bias_FPKM$table, 0.05, "Tpa LG", "FPKM", LG_max_FC),
plot_smear(Tps_LG_F_FPKM, "Tps_LG_F_FPKM", "Tps_LG_meanFPKM", TTT_LG_Tps_sex_bias_FPKM$table, 0.05, "Tps LG", "FPKM", LG_max_FC), ncol = 2)


pdf("SB_WB_FPKM_smear.pdf", width = 10, height = 15)
SB_WB_FPKM_smear
dev.off()
getwd() ## where has my plot gone....
...
## so same scale
WB_max_FC <- ceiling(max(abs(c(TTT_WB_Tbi_sex_bias_TPM$table$logFC, TTT_WB_Tce_sex_bias_TPM$table$logFC, TTT_WB_Tcm_sex_bias_TPM$table$logFC,TTT_WB_Tpa_sex_bias_TPM$table$logFC,TTT_WB_Tps_sex_bias_TPM$table$logFC))))
SB_WB_TPM_smear <- plot_grid(
plot_smear(Tbi_WB_F_TPM, "Tbi_WB_F_TPM", "Tbi_WB_meanTPM", TTT_WB_Tbi_sex_bias_TPM$table, 0.05, "Tbi WB", "TPM", WB_max_FC),
plot_smear(Tce_WB_F_TPM, "Tce_WB_F_TPM", "Tce_WB_meanTPM", TTT_WB_Tce_sex_bias_TPM$table, 0.05, "Tce WB", "TPM", WB_max_FC),
plot_smear(Tcm_WB_F_TPM, "Tcm_WB_F_TPM", "Tcm_WB_meanTPM", TTT_WB_Tcm_sex_bias_TPM$table, 0.05, "Tcm WB", "TPM", WB_max_FC),
plot_smear(Tpa_WB_F_TPM, "Tpa_WB_F_TPM", "Tpa_WB_meanTPM", TTT_WB_Tpa_sex_bias_TPM$table, 0.05, "Tpa WB", "TPM", WB_max_FC),
plot_smear(Tps_WB_F_TPM, "Tps_WB_F_TPM", "Tps_WB_meanTPM", TTT_WB_Tps_sex_bias_TPM$table, 0.05, "Tps WB", "TPM", WB_max_FC), ncol = 2)
...
plot_smear(Tbi_RT_F_TPM, "Tbi_RT_F_TPM", "Tbi_RT_meanTPM", TTT_RT_Tbi_sex_bias_TPM$table, 0.05, "Tbi RT", "TPM", RT_max_FC),
plot_smear(Tce_RT_F_TPM, "Tce_RT_F_TPM", "Tce_RT_meanTPM", TTT_RT_Tce_sex_bias_TPM$table, 0.05, "Tce RT", "TPM", RT_max_FC),
plot_smear(Tcm_RT_F_TPM, "Tcm_RT_F_TPM", "Tcm_RT_meanTPM", TTT_RT_Tcm_sex_bias_TPM$table, 0.05, "Tcm RT", "TPM", RT_max_FC),
plot_smear(Tpa_RT_F_TPM, "Tpa_RT_F_TPM", "Tpa_RT_meanTPM", TTT_RT_Tpa_sex_bias_TPM$table, 0.05, "Tpa RT", "TPM", RT_max_FC),
plot_smear(Tps_RT_F_TPM, "Tps_RT_F_TPM", "Tps_RT_meanTPM", TTT_RT_Tps_sex_bias_TPM$table, 0.05, "Tps RT", "TPM", RT_max_FC), ncol = 2)
...
plot_smear(Tbi_HD_F_TPM, "Tbi_HD_F_TPM", "Tbi_HD_meanTPM", TTT_HD_Tbi_sex_bias_TPM$table, 0.05, "Tbi HD", "TPM", HD_max_FC),
plot_smear(Tce_HD_F_TPM, "Tce_HD_F_TPM", "Tce_HD_meanTPM", TTT_HD_Tce_sex_bias_TPM$table, 0.05, "Tce HD", "TPM", HD_max_FC),
plot_smear(Tcm_HD_F_TPM, "Tcm_HD_F_TPM", "Tcm_HD_meanTPM", TTT_HD_Tcm_sex_bias_TPM$table, 0.05, "Tcm HD", "TPM", HD_max_FC),
plot_smear(Tpa_HD_F_TPM, "Tpa_HD_F_TPM", "Tpa_HD_meanTPM", TTT_HD_Tpa_sex_bias_TPM$table, 0.05, "Tpa HD", "TPM", HD_max_FC),
plot_smear(Tps_HD_F_TPM, "Tps_HD_F_TPM", "Tps_HD_meanTPM", TTT_HD_Tps_sex_bias_TPM$table, 0.05, "Tps HD", "TPM", HD_max_FC), ncol = 2)
...
plot_smear(Tbi_LG_F_TPM, "Tbi_LG_F_TPM", "Tbi_LG_meanTPM", TTT_LG_Tbi_sex_bias_TPM$table, 0.05, "Tbi LG", "TPM", LG_max_FC),
plot_smear(Tce_LG_F_TPM, "Tce_LG_F_TPM", "Tce_LG_meanTPM", TTT_LG_Tce_sex_bias_TPM$table, 0.05, "Tce LG", "TPM", LG_max_FC),
plot_smear(Tcm_LG_F_TPM, "Tcm_LG_F_TPM", "Tcm_LG_meanTPM", TTT_LG_Tcm_sex_bias_TPM$table, 0.05, "Tcm LG", "TPM", LG_max_FC),
plot_smear(Tpa_LG_F_TPM, "Tpa_LG_F_TPM", "Tpa_LG_meanTPM", TTT_LG_Tpa_sex_bias_TPM$table, 0.05, "Tpa LG", "TPM", LG_max_FC),
plot_smear(Tps_LG_F_TPM, "Tps_LG_F_TPM", "Tps_LG_meanTPM", TTT_LG_Tps_sex_bias_TPM$table, 0.05, "Tps LG", "TPM", LG_max_FC), ncol = 2)


pdf("SB_WB_TPM_smear.pdf", width = 10, height = 15)
SB_WB_TPM_smear
dev.off()
getwd() ## where has my plot gone....
...
SB_WB_FPKM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_WB_F_FPKM, "Tbi_WB_F_FPKM", "Tbi_WB_meanFPKM", TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, "Tbi WB", "FPKM", WB_max_FC, "soft"),
plot_smear_XA(Tce_WB_F_FPKM, "Tce_WB_F_FPKM", "Tce_WB_meanFPKM", TTT_WB_Tce_sex_bias_FPKM$table, 0.05, "Tce WB", "FPKM", WB_max_FC, "soft"),
plot_smear_XA(Tcm_WB_F_FPKM, "Tcm_WB_F_FPKM", "Tcm_WB_meanFPKM", TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, "Tcm WB", "FPKM", WB_max_FC, "soft"),
plot_smear_XA(Tpa_WB_F_FPKM, "Tpa_WB_F_FPKM", "Tpa_WB_meanFPKM", TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, "Tpa WB", "FPKM", WB_max_FC, "soft"),
plot_smear_XA(Tps_WB_F_FPKM, "Tps_WB_F_FPKM", "Tps_WB_meanFPKM", TTT_WB_Tps_sex_bias_FPKM$table, 0.05, "Tps WB", "FPKM", WB_max_FC, "soft"), ncol = 1)

SB_RT_FPKM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_RT_F_FPKM, "Tbi_RT_F_FPKM", "Tbi_RT_meanFPKM", TTT_RT_Tbi_sex_bias_FPKM$table, 0.05, "Tbi RT", "FPKM", RT_max_FC, "soft"),
plot_smear_XA(Tce_RT_F_FPKM, "Tce_RT_F_FPKM", "Tce_RT_meanFPKM", TTT_RT_Tce_sex_bias_FPKM$table, 0.05, "Tce RT", "FPKM", RT_max_FC, "soft"),
plot_smear_XA(Tcm_RT_F_FPKM, "Tcm_RT_F_FPKM", "Tcm_RT_meanFPKM", TTT_RT_Tcm_sex_bias_FPKM$table, 0.05, "Tcm RT", "FPKM", RT_max_FC, "soft"),
plot_smear_XA(Tpa_RT_F_FPKM, "Tpa_RT_F_FPKM", "Tpa_RT_meanFPKM", TTT_RT_Tpa_sex_bias_FPKM$table, 0.05, "Tpa RT", "FPKM", RT_max_FC, "soft"),
plot_smear_XA(Tps_RT_F_FPKM, "Tps_RT_F_FPKM", "Tps_RT_meanFPKM", TTT_RT_Tps_sex_bias_FPKM$table, 0.05, "Tps RT", "FPKM", RT_max_FC, "soft"), ncol = 1)

SB_HD_FPKM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_HD_F_FPKM, "Tbi_HD_F_FPKM", "Tbi_HD_meanFPKM", TTT_HD_Tbi_sex_bias_FPKM$table, 0.05, "Tbi HD", "FPKM", HD_max_FC, "soft"),
plot_smear_XA(Tce_HD_F_FPKM, "Tce_HD_F_FPKM", "Tce_HD_meanFPKM", TTT_HD_Tce_sex_bias_FPKM$table, 0.05, "Tce HD", "FPKM", HD_max_FC, "soft"),
plot_smear_XA(Tcm_HD_F_FPKM, "Tcm_HD_F_FPKM", "Tcm_HD_meanFPKM", TTT_HD_Tcm_sex_bias_FPKM$table, 0.05, "Tcm HD", "FPKM", HD_max_FC, "soft"),
plot_smear_XA(Tpa_HD_F_FPKM, "Tpa_HD_F_FPKM", "Tpa_HD_meanFPKM", TTT_HD_Tpa_sex_bias_FPKM$table, 0.05, "Tpa HD", "FPKM", HD_max_FC, "soft"),
plot_smear_XA(Tps_HD_F_FPKM, "Tps_HD_F_FPKM", "Tps_HD_meanFPKM", TTT_HD_Tps_sex_bias_FPKM$table, 0.05, "Tps HD", "FPKM", HD_max_FC, "soft"), ncol = 1)

SB_LG_FPKM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_LG_F_FPKM, "Tbi_LG_F_FPKM", "Tbi_LG_meanFPKM", TTT_LG_Tbi_sex_bias_FPKM$table, 0.05, "Tbi LG", "FPKM", LG_max_FC, "soft"),
plot_smear_XA(Tce_LG_F_FPKM, "Tce_LG_F_FPKM", "Tce_LG_meanFPKM", TTT_LG_Tce_sex_bias_FPKM$table, 0.05, "Tce LG", "FPKM", LG_max_FC, "soft"),
plot_smear_XA(Tcm_LG_F_FPKM, "Tcm_LG_F_FPKM", "Tcm_LG_meanFPKM", TTT_LG_Tcm_sex_bias_FPKM$table, 0.05, "Tcm LG", "FPKM", LG_max_FC, "soft"),
plot_smear_XA(Tpa_LG_F_FPKM, "Tpa_LG_F_FPKM", "Tpa_LG_meanFPKM", TTT_LG_Tpa_sex_bias_FPKM$table, 0.05, "Tpa LG", "FPKM", LG_max_FC, "soft"),
plot_smear_XA(Tps_LG_F_FPKM, "Tps_LG_F_FPKM", "Tps_LG_meanFPKM", TTT_LG_Tps_sex_bias_FPKM$table, 0.05, "Tps LG", "FPKM", LG_max_FC, "soft"), ncol = 1)



pdf("SB_WB_FPKM_smear_XA_soft.pdf", width = 9, height = 20)
SB_WB_FPKM_smear_XA_soft
dev.off()
getwd() ## where has my plot gone....
...
SB_WB_FPKM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_WB_F_FPKM, "Tbi_WB_F_FPKM", "Tbi_WB_meanFPKM", TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, "Tbi WB", "FPKM", WB_max_FC, "hard"),
plot_smear_XA(Tce_WB_F_FPKM, "Tce_WB_F_FPKM", "Tce_WB_meanFPKM", TTT_WB_Tce_sex_bias_FPKM$table, 0.05, "Tce WB", "FPKM", WB_max_FC, "hard"),
plot_smear_XA(Tcm_WB_F_FPKM, "Tcm_WB_F_FPKM", "Tcm_WB_meanFPKM", TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, "Tcm WB", "FPKM", WB_max_FC, "hard"),
plot_smear_XA(Tpa_WB_F_FPKM, "Tpa_WB_F_FPKM", "Tpa_WB_meanFPKM", TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, "Tpa WB", "FPKM", WB_max_FC, "hard"),
plot_smear_XA(Tps_WB_F_FPKM, "Tps_WB_F_FPKM", "Tps_WB_meanFPKM", TTT_WB_Tps_sex_bias_FPKM$table, 0.05, "Tps WB", "FPKM", WB_max_FC, "hard"), ncol = 1)

SB_RT_FPKM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_RT_F_FPKM, "Tbi_RT_F_FPKM", "Tbi_RT_meanFPKM", TTT_RT_Tbi_sex_bias_FPKM$table, 0.05, "Tbi RT", "FPKM", RT_max_FC, "hard"),
plot_smear_XA(Tce_RT_F_FPKM, "Tce_RT_F_FPKM", "Tce_RT_meanFPKM", TTT_RT_Tce_sex_bias_FPKM$table, 0.05, "Tce RT", "FPKM", RT_max_FC, "hard"),
plot_smear_XA(Tcm_RT_F_FPKM, "Tcm_RT_F_FPKM", "Tcm_RT_meanFPKM", TTT_RT_Tcm_sex_bias_FPKM$table, 0.05, "Tcm RT", "FPKM", RT_max_FC, "hard"),
plot_smear_XA(Tpa_RT_F_FPKM, "Tpa_RT_F_FPKM", "Tpa_RT_meanFPKM", TTT_RT_Tpa_sex_bias_FPKM$table, 0.05, "Tpa RT", "FPKM", RT_max_FC, "hard"),
plot_smear_XA(Tps_RT_F_FPKM, "Tps_RT_F_FPKM", "Tps_RT_meanFPKM", TTT_RT_Tps_sex_bias_FPKM$table, 0.05, "Tps RT", "FPKM", RT_max_FC, "hard"), ncol = 1)

SB_HD_FPKM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_HD_F_FPKM, "Tbi_HD_F_FPKM", "Tbi_HD_meanFPKM", TTT_HD_Tbi_sex_bias_FPKM$table, 0.05, "Tbi HD", "FPKM", HD_max_FC, "hard"),
plot_smear_XA(Tce_HD_F_FPKM, "Tce_HD_F_FPKM", "Tce_HD_meanFPKM", TTT_HD_Tce_sex_bias_FPKM$table, 0.05, "Tce HD", "FPKM", HD_max_FC, "hard"),
plot_smear_XA(Tcm_HD_F_FPKM, "Tcm_HD_F_FPKM", "Tcm_HD_meanFPKM", TTT_HD_Tcm_sex_bias_FPKM$table, 0.05, "Tcm HD", "FPKM", HD_max_FC, "hard"),
plot_smear_XA(Tpa_HD_F_FPKM, "Tpa_HD_F_FPKM", "Tpa_HD_meanFPKM", TTT_HD_Tpa_sex_bias_FPKM$table, 0.05, "Tpa HD", "FPKM", HD_max_FC, "hard"),
plot_smear_XA(Tps_HD_F_FPKM, "Tps_HD_F_FPKM", "Tps_HD_meanFPKM", TTT_HD_Tps_sex_bias_FPKM$table, 0.05, "Tps HD", "FPKM", HD_max_FC, "hard"), ncol = 1)

SB_LG_FPKM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_LG_F_FPKM, "Tbi_LG_F_FPKM", "Tbi_LG_meanFPKM", TTT_LG_Tbi_sex_bias_FPKM$table, 0.05, "Tbi LG", "FPKM", LG_max_FC, "hard"),
plot_smear_XA(Tce_LG_F_FPKM, "Tce_LG_F_FPKM", "Tce_LG_meanFPKM", TTT_LG_Tce_sex_bias_FPKM$table, 0.05, "Tce LG", "FPKM", LG_max_FC, "hard"),
plot_smear_XA(Tcm_LG_F_FPKM, "Tcm_LG_F_FPKM", "Tcm_LG_meanFPKM", TTT_LG_Tcm_sex_bias_FPKM$table, 0.05, "Tcm LG", "FPKM", LG_max_FC, "hard"),
plot_smear_XA(Tpa_LG_F_FPKM, "Tpa_LG_F_FPKM", "Tpa_LG_meanFPKM", TTT_LG_Tpa_sex_bias_FPKM$table, 0.05, "Tpa LG", "FPKM", LG_max_FC, "hard"),
plot_smear_XA(Tps_LG_F_FPKM, "Tps_LG_F_FPKM", "Tps_LG_meanFPKM", TTT_LG_Tps_sex_bias_FPKM$table, 0.05, "Tps LG", "FPKM", LG_max_FC, "hard"), ncol = 1)



pdf("SB_WB_FPKM_smear_XA_hard.pdf", width = 9, height = 20)
SB_WB_FPKM_smear_XA_hard
dev.off()
getwd() ## where has my plot gone....
...
SB_WB_TPM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_WB_F_TPM, "Tbi_WB_F_TPM", "Tbi_WB_meanTPM", TTT_WB_Tbi_sex_bias_TPM$table, 0.05, "Tbi WB", "TPM", WB_max_FC, "soft"),
plot_smear_XA(Tce_WB_F_TPM, "Tce_WB_F_TPM", "Tce_WB_meanTPM", TTT_WB_Tce_sex_bias_TPM$table, 0.05, "Tce WB", "TPM", WB_max_FC, "soft"),
plot_smear_XA(Tcm_WB_F_TPM, "Tcm_WB_F_TPM", "Tcm_WB_meanTPM", TTT_WB_Tcm_sex_bias_TPM$table, 0.05, "Tcm WB", "TPM", WB_max_FC, "soft"),
plot_smear_XA(Tpa_WB_F_TPM, "Tpa_WB_F_TPM", "Tpa_WB_meanTPM", TTT_WB_Tpa_sex_bias_TPM$table, 0.05, "Tpa WB", "TPM", WB_max_FC, "soft"),
plot_smear_XA(Tps_WB_F_TPM, "Tps_WB_F_TPM", "Tps_WB_meanTPM", TTT_WB_Tps_sex_bias_TPM$table, 0.05, "Tps WB", "TPM", WB_max_FC, "soft"), ncol = 1)

SB_RT_TPM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_RT_F_TPM, "Tbi_RT_F_TPM", "Tbi_RT_meanTPM", TTT_RT_Tbi_sex_bias_TPM$table, 0.05, "Tbi RT", "TPM", RT_max_FC, "soft"),
plot_smear_XA(Tce_RT_F_TPM, "Tce_RT_F_TPM", "Tce_RT_meanTPM", TTT_RT_Tce_sex_bias_TPM$table, 0.05, "Tce RT", "TPM", RT_max_FC, "soft"),
plot_smear_XA(Tcm_RT_F_TPM, "Tcm_RT_F_TPM", "Tcm_RT_meanTPM", TTT_RT_Tcm_sex_bias_TPM$table, 0.05, "Tcm RT", "TPM", RT_max_FC, "soft"),
plot_smear_XA(Tpa_RT_F_TPM, "Tpa_RT_F_TPM", "Tpa_RT_meanTPM", TTT_RT_Tpa_sex_bias_TPM$table, 0.05, "Tpa RT", "TPM", RT_max_FC, "soft"),
plot_smear_XA(Tps_RT_F_TPM, "Tps_RT_F_TPM", "Tps_RT_meanTPM", TTT_RT_Tps_sex_bias_TPM$table, 0.05, "Tps RT", "TPM", RT_max_FC, "soft"), ncol = 1)

SB_HD_TPM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_HD_F_TPM, "Tbi_HD_F_TPM", "Tbi_HD_meanTPM", TTT_HD_Tbi_sex_bias_TPM$table, 0.05, "Tbi HD", "TPM", HD_max_FC, "soft"),
plot_smear_XA(Tce_HD_F_TPM, "Tce_HD_F_TPM", "Tce_HD_meanTPM", TTT_HD_Tce_sex_bias_TPM$table, 0.05, "Tce HD", "TPM", HD_max_FC, "soft"),
plot_smear_XA(Tcm_HD_F_TPM, "Tcm_HD_F_TPM", "Tcm_HD_meanTPM", TTT_HD_Tcm_sex_bias_TPM$table, 0.05, "Tcm HD", "TPM", HD_max_FC, "soft"),
plot_smear_XA(Tpa_HD_F_TPM, "Tpa_HD_F_TPM", "Tpa_HD_meanTPM", TTT_HD_Tpa_sex_bias_TPM$table, 0.05, "Tpa HD", "TPM", HD_max_FC, "soft"),
plot_smear_XA(Tps_HD_F_TPM, "Tps_HD_F_TPM", "Tps_HD_meanTPM", TTT_HD_Tps_sex_bias_TPM$table, 0.05, "Tps HD", "TPM", HD_max_FC, "soft"), ncol = 1)

SB_LG_TPM_smear_XA_soft <- plot_grid(
plot_smear_XA(Tbi_LG_F_TPM, "Tbi_LG_F_TPM", "Tbi_LG_meanTPM", TTT_LG_Tbi_sex_bias_TPM$table, 0.05, "Tbi LG", "TPM", LG_max_FC, "soft"),
plot_smear_XA(Tce_LG_F_TPM, "Tce_LG_F_TPM", "Tce_LG_meanTPM", TTT_LG_Tce_sex_bias_TPM$table, 0.05, "Tce LG", "TPM", LG_max_FC, "soft"),
plot_smear_XA(Tcm_LG_F_TPM, "Tcm_LG_F_TPM", "Tcm_LG_meanTPM", TTT_LG_Tcm_sex_bias_TPM$table, 0.05, "Tcm LG", "TPM", LG_max_FC, "soft"),
plot_smear_XA(Tpa_LG_F_TPM, "Tpa_LG_F_TPM", "Tpa_LG_meanTPM", TTT_LG_Tpa_sex_bias_TPM$table, 0.05, "Tpa LG", "TPM", LG_max_FC, "soft"),
plot_smear_XA(Tps_LG_F_TPM, "Tps_LG_F_TPM", "Tps_LG_meanTPM", TTT_LG_Tps_sex_bias_TPM$table, 0.05, "Tps LG", "TPM", LG_max_FC, "soft"), ncol = 1)



pdf("SB_WB_TPM_smear_XA_soft.pdf", width = 9, height = 20)
SB_WB_TPM_smear_XA_soft
dev.off()
getwd() ## where has my plot gone....
...
SB_WB_TPM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_WB_F_TPM, "Tbi_WB_F_TPM", "Tbi_WB_meanTPM", TTT_WB_Tbi_sex_bias_TPM$table, 0.05, "Tbi WB", "TPM", WB_max_FC, "hard"),
plot_smear_XA(Tce_WB_F_TPM, "Tce_WB_F_TPM", "Tce_WB_meanTPM", TTT_WB_Tce_sex_bias_TPM$table, 0.05, "Tce WB", "TPM", WB_max_FC, "hard"),
plot_smear_XA(Tcm_WB_F_TPM, "Tcm_WB_F_TPM", "Tcm_WB_meanTPM", TTT_WB_Tcm_sex_bias_TPM$table, 0.05, "Tcm WB", "TPM", WB_max_FC, "hard"),
plot_smear_XA(Tpa_WB_F_TPM, "Tpa_WB_F_TPM", "Tpa_WB_meanTPM", TTT_WB_Tpa_sex_bias_TPM$table, 0.05, "Tpa WB", "TPM", WB_max_FC, "hard"),
plot_smear_XA(Tps_WB_F_TPM, "Tps_WB_F_TPM", "Tps_WB_meanTPM", TTT_WB_Tps_sex_bias_TPM$table, 0.05, "Tps WB", "TPM", WB_max_FC, "hard"), ncol = 1)

SB_RT_TPM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_RT_F_TPM, "Tbi_RT_F_TPM", "Tbi_RT_meanTPM", TTT_RT_Tbi_sex_bias_TPM$table, 0.05, "Tbi RT", "TPM", RT_max_FC, "hard"),
plot_smear_XA(Tce_RT_F_TPM, "Tce_RT_F_TPM", "Tce_RT_meanTPM", TTT_RT_Tce_sex_bias_TPM$table, 0.05, "Tce RT", "TPM", RT_max_FC, "hard"),
plot_smear_XA(Tcm_RT_F_TPM, "Tcm_RT_F_TPM", "Tcm_RT_meanTPM", TTT_RT_Tcm_sex_bias_TPM$table, 0.05, "Tcm RT", "TPM", RT_max_FC, "hard"),
plot_smear_XA(Tpa_RT_F_TPM, "Tpa_RT_F_TPM", "Tpa_RT_meanTPM", TTT_RT_Tpa_sex_bias_TPM$table, 0.05, "Tpa RT", "TPM", RT_max_FC, "hard"),
plot_smear_XA(Tps_RT_F_TPM, "Tps_RT_F_TPM", "Tps_RT_meanTPM", TTT_RT_Tps_sex_bias_TPM$table, 0.05, "Tps RT", "TPM", RT_max_FC, "hard"), ncol = 1)

SB_HD_TPM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_HD_F_TPM, "Tbi_HD_F_TPM", "Tbi_HD_meanTPM", TTT_HD_Tbi_sex_bias_TPM$table, 0.05, "Tbi HD", "TPM", HD_max_FC, "hard"),
plot_smear_XA(Tce_HD_F_TPM, "Tce_HD_F_TPM", "Tce_HD_meanTPM", TTT_HD_Tce_sex_bias_TPM$table, 0.05, "Tce HD", "TPM", HD_max_FC, "hard"),
plot_smear_XA(Tcm_HD_F_TPM, "Tcm_HD_F_TPM", "Tcm_HD_meanTPM", TTT_HD_Tcm_sex_bias_TPM$table, 0.05, "Tcm HD", "TPM", HD_max_FC, "hard"),
plot_smear_XA(Tpa_HD_F_TPM, "Tpa_HD_F_TPM", "Tpa_HD_meanTPM", TTT_HD_Tpa_sex_bias_TPM$table, 0.05, "Tpa HD", "TPM", HD_max_FC, "hard"),
plot_smear_XA(Tps_HD_F_TPM, "Tps_HD_F_TPM", "Tps_HD_meanTPM", TTT_HD_Tps_sex_bias_TPM$table, 0.05, "Tps HD", "TPM", HD_max_FC, "hard"), ncol = 1)

SB_LG_TPM_smear_XA_hard <- plot_grid(
plot_smear_XA(Tbi_LG_F_TPM, "Tbi_LG_F_TPM", "Tbi_LG_meanTPM", TTT_LG_Tbi_sex_bias_TPM$table, 0.05, "Tbi LG", "TPM", LG_max_FC, "hard"),
plot_smear_XA(Tce_LG_F_TPM, "Tce_LG_F_TPM", "Tce_LG_meanTPM", TTT_LG_Tce_sex_bias_TPM$table, 0.05, "Tce LG", "TPM", LG_max_FC, "hard"),
plot_smear_XA(Tcm_LG_F_TPM, "Tcm_LG_F_TPM", "Tcm_LG_meanTPM", TTT_LG_Tcm_sex_bias_TPM$table, 0.05, "Tcm LG", "TPM", LG_max_FC, "hard"),
plot_smear_XA(Tpa_LG_F_TPM, "Tpa_LG_F_TPM", "Tpa_LG_meanTPM", TTT_LG_Tpa_sex_bias_TPM$table, 0.05, "Tpa LG", "TPM", LG_max_FC, "hard"),
plot_smear_XA(Tps_LG_F_TPM, "Tps_LG_F_TPM", "Tps_LG_meanTPM", TTT_LG_Tps_sex_bias_TPM$table, 0.05, "Tps LG", "TPM", LG_max_FC, "hard"), ncol = 1)



pdf("SB_WB_TPM_smear_XA_hard.pdf", width = 9, height = 20)
SB_WB_TPM_smear_XA_hard
dev.off()
getwd() ## where has my plot gone....
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, 0, dat1_Tbi, "chr_hard"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_FPKM$table, 0.05, 0, dat1_Tce, "chr_hard"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, 0, dat1_Tcm, "chr_hard"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, 0, dat1_Tpa, "chr_hard"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_FPKM$table, 0.05, 0, dat1_Tps, "chr_hard"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, 0, dat1_Tbi, "chr_soft"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_FPKM$table, 0.05, 0, dat1_Tce, "chr_soft"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, 0, dat1_Tcm, "chr_soft"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, 0, dat1_Tpa, "chr_soft"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_FPKM$table, 0.05, 0, dat1_Tps, "chr_soft"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_TPM$table, 0.05, 0, dat1_Tbi, "chr_hard"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_TPM$table, 0.05, 0, dat1_Tce, "chr_hard"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_TPM$table, 0.05, 0, dat1_Tcm, "chr_hard"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_TPM$table, 0.05, 0, dat1_Tpa, "chr_hard"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_TPM$table, 0.05, 0, dat1_Tps, "chr_hard"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_TPM$table, 0.05, 0, dat1_Tbi, "chr_soft"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_TPM$table, 0.05, 0, dat1_Tce, "chr_soft"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_TPM$table, 0.05, 0, dat1_Tcm, "chr_soft"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_TPM$table, 0.05, 0, dat1_Tpa, "chr_soft"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_TPM$table, 0.05, 0, dat1_Tps, "chr_soft"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, 1, dat1_Tbi, "chr_hard"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_FPKM$table, 0.05, 1, dat1_Tce, "chr_hard"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, 1, dat1_Tcm, "chr_hard"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, 1, dat1_Tpa, "chr_hard"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_FPKM$table, 0.05, 1, dat1_Tps, "chr_hard"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_FPKM$table, 0.05, 1, dat1_Tbi, "chr_soft"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_FPKM$table, 0.05, 1, dat1_Tce, "chr_soft"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_FPKM$table, 0.05, 1, dat1_Tcm, "chr_soft"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_FPKM$table, 0.05, 1, dat1_Tpa, "chr_soft"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_FPKM$table, 0.05, 1, dat1_Tps, "chr_soft"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_TPM$table, 0.05, 1, dat1_Tbi, "chr_hard"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_TPM$table, 0.05, 1, dat1_Tce, "chr_hard"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_TPM$table, 0.05, 1, dat1_Tcm, "chr_hard"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_TPM$table, 0.05, 1, dat1_Tpa, "chr_hard"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_TPM$table, 0.05, 1, dat1_Tps, "chr_hard"),
...
MB_FB_on_X(TTT_WB_Tbi_sex_bias_TPM$table, 0.05, 1, dat1_Tbi, "chr_soft"),
MB_FB_on_X(TTT_WB_Tce_sex_bias_TPM$table, 0.05, 1, dat1_Tce, "chr_soft"),
MB_FB_on_X(TTT_WB_Tcm_sex_bias_TPM$table, 0.05, 1, dat1_Tcm, "chr_soft"),
MB_FB_on_X(TTT_WB_Tpa_sex_bias_TPM$table, 0.05, 1, dat1_Tpa, "chr_soft"),
MB_FB_on_X(TTT_WB_Tps_sex_bias_TPM$table, 0.05, 1, dat1_Tps, "chr_soft"),
...
plot_SB_XA <-  function(FT_df, run_type){
	...
	FT_df$tiss_ord <- ordered(FT_df$tiss, levels = c("WB", "RT", "HD", "LG"))
	...
	prop_FB_X_A_df_WB <- subset(prop_FB_X_A_df,prop_FB_X_A_df$tiss == "WB")
	...
	prop_MB_X_A_df_WB <- subset(prop_MB_X_A_df,prop_MB_X_A_df$tiss == "WB")
	...
	P_FB_WB <- prop_FB_plot(prop_FB_X_A_df_WB, max(prop_FB_X_A_df_WB$prop_FB, prop_MB_X_A_df_WB$prop_MB) * 1.05, paste("WB | FB", run_type, sep = " | "))
	...
	P_MB_WB <- prop_MB_plot(prop_MB_X_A_df_WB, max(prop_FB_X_A_df_WB$prop_FB, prop_MB_X_A_df_WB$prop_MB) * 1.05, paste("WB | MB", run_type, sep = " | "))
	...
	P_out_prop <- plot_grid(P_FB_WB, P_MB_WB, P_FB_RT, P_MB_RT, P_FB_HD, P_MB_HD, P_FB_LG, P_MB_LG, ncol = 2  )
...
pdf("prop_SB_FT_MB_FB_X_A_hard_FPKM_wFC.pdf", width = 8, height = 12)
plot_SB_XA(FT_MB_FB_X_A_hard_FPKM_wFC_df, "hard_FPKM_wFC")$P_out_prop
dev.off()
getwd() ## where has my plot gone....

pdf("prop_SB_FT_MB_FB_X_A_soft_FPKM_wFC.pdf", width = 8, height = 12)
...
pdf("prop_SB_FT_MB_FB_X_A_hard_TPM_wFC.pdf", width = 8, height = 12)
plot_SB_XA(FT_MB_FB_X_A_hard_TPM_wFC_df, "hard_TPM_wFC")$P_out_prop
dev.off()
getwd() ## where has my plot gone....

pdf("prop_SB_FT_MB_FB_X_A_soft_TPM_wFC.pdf", width = 8, height = 12)
...
pdf("prop_SB_FT_MB_FB_X_A_hard_FPKM.pdf", width = 8, height = 12)
plot_SB_XA(FT_MB_FB_X_A_hard_FPKM_df, "hard_FPKM")$P_out_prop
dev.off()
getwd() ## where has my plot gone....

pdf("prop_SB_FT_MB_FB_X_A_soft_FPKM.pdf", width = 8, height = 12)
...
pdf("prop_SB_FT_MB_FB_X_A_hard_TPM.pdf", width = 8, height = 12)
plot_SB_XA(FT_MB_FB_X_A_hard_TPM_df, "hard_TPM")$P_out_prop
dev.off()
getwd() ## where has my plot gone....

pdf("prop_SB_FT_MB_FB_X_A_soft_TPM.pdf", width = 8, height = 12)
