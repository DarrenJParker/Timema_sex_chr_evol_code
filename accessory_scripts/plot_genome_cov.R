...
png(filename = paste(in_file_name, "covest_1.png", sep = ""), width = 8, height = 6, units = "in", bg = "white", res = 300)
output$p1
dev.off()
...
pdf(paste(in_file_name, "covest_1.pdf", sep = ""), width = 8, height = 6)
output$p1
dev.off()
getwd() ## where has my plot gone....


pdf(paste(in_file_name, "covest_2.pdf", sep = ""), width = 8, height = 6)
output$p2
dev.off()
getwd() ## where has my plot gone....
